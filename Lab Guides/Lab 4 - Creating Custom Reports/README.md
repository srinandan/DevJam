<span id="h.gjdgxs"
class="anchor"></span>![](./media/image14.png){width="8.5in"
height="1.3888888888888888e-2in"}

**Lab 4 - Creating Custom Reports**

![](./media/image16.png){width="6.5in" height="2.888888888888889in"}
...
![](./media/image15.png){width="6.5in" height="2.236111111111111in"}
...
a.  Select the ‘Extract Variables’ policy with the following properties:

    i.  Policy Display Name: **Extract Variables**

    ii. Policy Name: **Extract-Variables**

> ![](./media/image27.png){width="4.473958880139983in"
> height="1.4626399825021872in"}

a.  For the ‘Extract Variables’ policy, change the XML configuration of
...
a.  Select the ‘Statistics Collector’ policy with the following
    > properties:
...
>
> ![](./media/image17.png){width="3.1222069116360456in"
...
> ![](./media/image13.png){width="5.942708880139983in"
> height="2.8665944881889764in"}

2.  Define the custom report - Enter the values as indicated below and
    > click on the blue “Save” button.

> ![](./media/image24.png){width="5.901042213473316in"
> height="3.0167180664916886in"}
>
> ![](./media/image18.png){width="5.889594269466317in"
...
> ![](./media/image20.png){width="5.682292213473316in"
> height="3.3419892825896764in"}
...
> ![](./media/image19.png){width="6.5in" height="6.027777777777778in"}
